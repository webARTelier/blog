      ...
      <div class="c-post__wrapper">
        ...
        <div class="c-meta">
          <div class="c-meta__item">
            ...
            <a class="c-meta__link" href="javascript:;">allgemein</a>
          </div>
          <div class="c-meta__item">
        ...
        <div class="c-post__content">
          ...
          <div class="c-post__abstract">
            ...
            <a class="c-post__more" href="javascript:;">Read more →</a>
          </div>
    ...
    <div class="c-post">
      ...
      <div class="c-post__wrapper">
        ...
        <div class="c-meta">
          <div class="c-meta__item">
            <svg class="c-meta__icon"><use xlink:href="images/icons.svg#icon-list"></use></svg>
            <a class="c-meta__link" href="javascript:;">allgemeines</a>
          </div>
          <div class="c-meta__item">
            <svg class="c-meta__icon"><use xlink:href="images/icons.svg#icon-bubble"></use></svg>
            <a class="c-meta__link" href="javascript:;">12 Kommentare</a>
          </div>
        </div>
        <!-- post meta -->

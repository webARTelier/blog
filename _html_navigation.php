    ...
    <div id="asideMenu" class="c-tab js-tabContent">
      <div class="c-nav__items">
        ...
        <div class="c-nav__item">
          <h2 class="c-nav__title">letzte artikel</h2>
          <a class="c-nav__link" href="javascript:;">lorem ipsum</a>
          <a class="c-nav__link" href="javascript:;">dolor sit</a>
        </div>
        ...
        <div class="c-nav__item">
          <h2 class="c-nav__title">archiv</h2>
          <a class="c-nav__link" href="javascript:;">lorem ipsum</a>
          <a class="c-nav__link" href="javascript:;">dolor sit</a>
        </div>
